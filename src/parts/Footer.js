            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-auto mr-5">
                        <h6 className="h6 mt-2 ">For Beginners</h6>
                    ...
                    <h6 className="h6 mt-2 ">Explore Us</h6>
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                    ...
                    <div className="col-3">
                    <h6 className="h6 mt-2 ">Connect Us</h6>
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                <Button isExternal type="link" href="mailto:support@staycation.id">support@staycation.id</Button>
                            </li>
                            <li className="list-group-item">
                                <Button isExternal type="link" href="tel:+6282230174053">082230174053</Button>
                            </li>
                            <li className="list-group-item">
                                <span>Staycation, Cilegon, Banten</span>
                            </li>
